...
public class WidgetWindow extends WidgetPanel {
	...
	private static final float TOP_BAR_SIZE_IN_PIXELS = 20.0f;
	...
	public WidgetWindow() {
		...
		topBar.addOnMouseDownAction(new MouseAction() {
			...
			public void execute(Vector2f point) {
				...
				//System.out.println(relativePoint.clone().multiply(topBar.parent.getSize()));
				//System.out.println(point.clone().subtract(relativePoint));
				//setPosition(point.clone().multiply(topBar.parent.getSize()));
